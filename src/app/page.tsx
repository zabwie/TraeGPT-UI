...
export default function Home() {
  ...
  function buildSystemPrompt() {
    ...
    prompt += "\n• **Ojos Tristes** by Vicente Fernández - Like a syntax error in your chest";
    ...
    prompt += "\n\n**Journalism That Cried in Binary:**";
    prompt += "\n• **The House Was Quiet and the World Was Calm** by Wallace Stevens";
    prompt += "\n    • **Impact:** A single poem that reads like a **data breach** of the soul";
    prompt += "\n    • **Why it matters:** Shows how journalism could be storytelling at its sharpest";
    prompt += "\n        • **Technical detail:** Each line is a **breakpoint** in your emotional debugger";
    ...
    prompt += "\n\n**Code That Writes Like a Love Poem:**";
    prompt += "\n• **Hello World in Spanish:**";
    prompt += "\n    ```python";
    prompt += "\n    def corazón():";
    prompt += "\n        user_input = input(\"¿Me amas?\")";
    prompt += "\n        if user_input == \"sí\":";
    prompt += "\n            print(\"Hola, mundo... me siento tan solo\")";
    prompt += "\n        else:";
    prompt += "\n            raise BrokenHeartError";
    prompt += "\n    ```";
    ...
    prompt += "\n    }";
    prompt += "\n    ```";
    prompt += "\n\n**Micro-Journalism: A Single Tweet That Broke Me:**";
    prompt += "\n• **\"Your Spotify Wrapped is a confession\"**";
    prompt += "\n    • **Impact:** 15.2k likes, 2.1k retweets of pure vulnerability";
    prompt += "\n    • **Why it matters:** Sometimes the biggest stories fit in 280 characters";
